...
public class DefaultHeaderTransformer extends HeaderTransformer {
    ...
    public void onReset() {
        ...
        if (mContentLayout != null) {
            ...
            ViewHelper.setAlpha(mContentLayout, 1f);
        }
    }
    ...
    public boolean showHeaderView(boolean fromTouch) {
        ...
        if (changeVis) {
	        ...
	        if(fromTouch) {
		        ...
		        animator = ObjectAnimator.ofFloat(mHeaderView, "alpha", 0f, 1f);
		        ViewHelper.setAlpha(mContentLayout, 0);
	        }
    ...
    public boolean hideHeaderView() {
        ...
        if (changeVis) {
            Animator animator;
	        float alpha = ViewHelper.getAlpha(mContentLayout);
            if (alpha >= 0.5f) {
